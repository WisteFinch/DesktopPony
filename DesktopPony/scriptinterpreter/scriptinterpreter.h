...
private:
    ...
    void iIfBody(ScriptParserNode *node, QMap<QString, QVector<QPair<int, Value> >* > *data, QVector<QVector<QString> *> *record, int layer, bool flag); ///< if主体
    ...
    Value iConditionalBodyExpression(bool flag, ScriptParserNode *node, QMap<QString, QVector<QPair<int, Value> >* > *data, QVector<QVector<QString> *> *record, int layer); ///< 条件表达式
    ...
    Value getVariable(QString id, VALUE_TYPE t, QMap<QString, QVector<QPair<int, Value> >* > *data);
    void insertVariable(QString id, Value v, QMap<QString, QVector<QPair<int, Value> >* > *data, QVector<QVector<QString> *> *record, int layer);
    void clearVariable(QMap<QString, QVector<QPair<int, Value> >* > *data, QVector<QVector<QString> *> *record, int layer);

    void error(QMap<QString, QVector<QPair<int, Value> >* > *data, QVector<QVector<QString> *> *record, int layer);
};
