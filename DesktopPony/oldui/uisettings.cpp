...
void UISettings::initText()
{
    ...
    this->m_label_character_switch_title->setText(this->m_p_localisation->get(this->m_label_character_switch_title->objectName()) + this->m_p_config->get("characterName").toString()); //“选择角色”
    ...
    this->m_label_info_version_content->setText(this->m_p_config->get("version").toString());
...
{
    this->m_lineedit_general_option_character_size->setText(QString::number(this->m_p_config->get("characterSize").toInt()));    //“选项-角色大小”
    this->m_lineedit_general_constant_gravitational_acceleration->setText(QString::number(this->m_p_config->get("gravitationalAcceleration").toInt()));    //“常量-重力加速度”
    this->m_lineedit_general_constant_obstruction->setText(QString::number(this->m_p_config->get("obstruction").toInt()));    //“常量-阻力”
}

void UISettings::saveValue()
{
    this->m_p_config->set("characterSize", this->m_lineedit_general_option_character_size->text().toInt());    //“选项-角色大小”
    this->m_p_config->set("gravitationalAcceleration", this->m_lineedit_general_constant_gravitational_acceleration->text().toDouble());    //“常量-重力加速度”
    this->m_p_config->set("obstruction", this->m_lineedit_general_constant_obstruction->text().toDouble());    //“常量-阻力”
...
void UISettings::slotUICharacterBack(QString name)
{
    ...
    if(name != nullptr) {
        this->m_p_config->set("characterName", name);
        this->m_p_config->save();
